-- Migration to enhance user_favorites table for proper favorites storage
-- Adds support for both default and custom symbols with complete data storage
-- Ensures proper user isolation and clean separation from phrase_history
