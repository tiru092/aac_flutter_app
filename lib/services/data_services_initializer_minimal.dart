...
class DataServicesInitializer {
  ...
  Future<void> initialize() async {
    ...
    try {
      ...
      // 4. Initialize CustomCategoriesService with Firebase UID support
      _customCategoriesService = CustomCategoriesService();
      await _customCategoriesService!.initializeWithUid(_userDataManager!.currentUserId!, _userDataManager!);
      AACLogger.info('✅ CustomCategoriesService initialized with Firebase UID isolation');
  ...
  void logServiceStatus() {
    ...
    if (_isInitialized) {
      ...
      AACLogger.info('CustomCategoriesService: ${_customCategoriesService != null ? "✅ Active with Firebase UID isolation" : "❌ Not initialized"}');
    }
